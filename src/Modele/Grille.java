...
public class Grille {
    ...
    public Grille(ArrayList<Tuile> tuiles, ArrayList<Carte_Inond> piocheInond) {
        ...
        piocheInond.add(Carte_Inond_La_Porte_de_Bronze);
        ...
        piocheInond.add(Carte_Inond_La_Caverne_des_Ombres);
        ...
        piocheInond.add(Carte_Inond_La_Porte_de_Fer);
        ...
        piocheInond.add(Carte_Inond_La_Porte_dOr);
        ...
        piocheInond.add(Carte_Inond_Les_Falaises_de_lOubli);
        ...
        piocheInond.add(Carte_Inond_Le_Palais_de_Corail);
        ...
        piocheInond.add(Carte_Inond_Les_Dunes_de_lIllusion);
        ...
        tuiles.add(Heliport);
        piocheInond.add(Carte_Inond_Heliport);
        ...
        piocheInond.add(Carte_Inond_La_Porte_de_Cuivre);
        ...
        piocheInond.add(Carte_Inond_Le_Jardin_des_Hurlements);
        ...
        piocheInond.add(Carte_Inond_La_Caverne_du_Brasier);
        ...
        piocheInond.add(Carte_Inond_Le_Temple_de_La_Lune);
        ...
        piocheInond.add(Carte_Inond_Le_Palais_des_Marees);
        ...
        piocheInond.add(Carte_Inond_Le_Val_du_Crepuscule);
        ...
        piocheInond.add(Carte_Inond_Le_Jardin_des_Murmures);
